...
import { registerWithEmail, signInWithGoogle } from "@/utilities/firebase_auth_functions";
...
const Register = () => {
  ...
  const handleGoogleSignup = async() => {
    ...
    try {
      ...
      setEmailError('Google signin failed');
    }
  }
      ...
      >
        ...
        <div className="buttons-container">
          <div className="apple-login-button">
            ...
            >
              <BsMicrosoft color="white" style={{ backgroundColor: "transparent" }} size={'100%'}/>
            </svg>
